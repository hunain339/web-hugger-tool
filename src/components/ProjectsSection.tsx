...
const pythonProjects: Project[] = [
  {
    ...
    description:
      "A Python application that fetches real-time weather data using the Requests module and external APIs.",
    tech: ["Python", "Requests", "API"],
    codeUrl:
      "https://github.com/hunain339/python-work/blob/main/request%20module%202.py",
    icon: <Terminal size={20} />,
  },
  {
    title: "Music Playlist Manager",
    description:
      "A command-line music list manager built in Python for organizing and managing playlists efficiently.",
    tech: ["Python", "Data Structures"],
    codeUrl:
      "https://github.com/hunain339/python-work/blob/main/music%20list.py",
    icon: <Terminal size={20} />,
  },
  {
    title: "Water Intake Tracker",
    description:
      "A Python app that helps users track and monitor their daily water intake with smart reminders.",
    tech: ["Python", "CLI"],
    codeUrl:
      "https://github.com/hunain339/python-work/blob/main/water%20app.py",
    icon: <Terminal size={20} />,
  },
  {
    title: "Main Project",
    description:
      "A comprehensive Python project showcasing core programming concepts including OOP and file handling.",
    tech: ["Python", "OOP", "File I/O"],
    codeUrl:
      "https://github.com/hunain339/python-work/blob/main/main%20project.py",
    icon: <Terminal size={20} />,
  },
];
...
const webProjects: Project[] = [
  {
    ...
    description:
      "A professional coaching institute website featuring responsive design, smooth animations, course listings, and a modern UI built with pure HTML & CSS.",
  ...
  },
  {
    ...
    description:
      "A modern, responsive developer portfolio built with React, TypeScript, Tailwind CSS, and Framer Motion featuring smooth animations and interactive sections.",
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        transition:
          "transform 0.3s cubic-bezier(0.4,0,0.2,1), box-shadow 0.3s, border-color 0.3s",
      }}
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(168 80% 50% / 0.08), hsl(270 60% 60% / 0.08))",
        }}
      />
